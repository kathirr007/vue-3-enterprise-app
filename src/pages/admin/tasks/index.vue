...
const { activeTabIndex, activeTab, tabRef, handleTabChange }
  = useSteps('admin-tasks');
  ...
  <div v-else>
      ...
      <TabPanel header="Team">
        <CommonPage :title="`Team ( ${currentStatus ? currentStatus : ''} )`">
          ...
          <TasksList
            ...
            ref="tasksListRef"
            entity-type="TASK"
            :disabled-filters="['Start Date', 'Assigned To']"
    ...
    <CommonPage v-else title="Tasks">
      ...
      <TasksMobileList
        ...
        ref="tasksListRef"
        entity-type="TASK"
        :disabled-filters="['Start Date', 'Project Manager', 'Assigned To']"
        @success="refreshCardData()"
      />
      <div v-else class="card">
        <p class="text-center font-medium text-xl">
